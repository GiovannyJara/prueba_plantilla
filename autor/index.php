...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/template/css/style.css">
	<link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/template/css/slick.css">
	<title>Author</title>
</head>
<body>
	...
	<nav class="site-navigation">
		<div class="site-navigation-inner site-container">
			<img src="<?php echo get_template_directory_uri();?>/template/images/site-logo.png" alt="site logo">
	...
	<section class="fh5co-top-banner">
		<div class="top-banner__inner site-container">
			<div class="top-banner__image">
				<img src="<?php echo get_template_directory_uri();?>/template/images/top-banner-author.jpg" alt="author image">
			</div>
		...
		<div class="about-me-inner site-container">
			<article class="portfolio-wrapper">
				<div class="portfolio__img">
					<img src="<?php echo get_template_directory_uri();?>/template/images/about-me.jpg" class="about-me__profile" alt="about me profile picture">
				</div>
			...
			<div class="books">
				<div class="single-book">
					<a href="#" class="single-book__img">
						<img src="<?php echo get_template_directory_uri();?>/template/images/books-1.jpg" alt="single book and cd">
						<div class="single-book_download">
							<img src="<?php echo get_template_directory_uri();?>/template/images/download.svg" alt="book image">
						</div>
					</a>
				...
				<div class="single-book">
					<a href="#" class="single-book__img">
						<img src="<?php echo get_template_directory_uri();?>/template/images/books-2.jpg" alt="single book and cd">
						<div class="single-book_download">
							<img src="<?php echo get_template_directory_uri();?>/template/images/download.svg" alt="book image">
						</div>
					</a>
				...
				<div class="single-book">
					<a href="#" class="single-book__img">
						<img src="<?php echo get_template_directory_uri();?>/template/images/books-3.jpg" alt="single book and cd">
						<div class="single-book_download">
							<img src="<?php echo get_template_directory_uri();?>/template/images/download.svg" alt="book image">
						</div>
					</a>
				...
				<div class="single-book">
					<a href="#" class="single-book__img">
						<img src="<?php echo get_template_directory_uri();?>/template/images/books-4.jpg" alt="single book and cd">
						<div class="single-book_download">
							<img src="<?php echo get_template_directory_uri();?>/template/images/download.svg" alt="book image">
						</div>
					</a>
		...
		<div class="counter-inner site-container">
			<div class="single-count">
				...
				<div class="single-count__text">
					<img src="<?php echo get_template_directory_uri();?>/template/images/counter-1.png" alt="counter icon">
					<p>Books</p>
				</div>
			</div>
			<div class="single-count">
				...
				<div class="single-count__text">
					<img src="<?php echo get_template_directory_uri();?>/template/images/counter-2.png" alt="counter icon">
					<p>Pages</p>
				</div>
			</div>
			<div class="single-count">
				...
				<div class="single-count__text">
					<img src="<?php echo get_template_directory_uri();?>/template/images/counter-3.png" alt="counter icon">
					<p>Sales</p>
				</div>
			</div>
			<div class="single-count">
				...
				<div class="single-count__text">
					<img src="<?php echo get_template_directory_uri();?>/template/images/counter-4.png" alt="counter icon">
					<p>Awards</p>
				</div>
			</div>
		</div>
			...
			<div class="blog-slider blog-inner">
				<div class="single-blog">
					<div class="single-blog__img">
						<img src="<?php echo get_template_directory_uri();?>/template/images/blog1.jpg" alt="blog image">
					</div>
				...
				<div class="single-blog">
					<div class="single-blog__img">
						<img src="<?php echo get_template_directory_uri();?>/template/images/blog2.jpg" alt="blog image">
					</div>
					<div class="single-blog__text">
						<h4>The Journey Under the Waves</h4>
						<span>On August 28, 2015</span>
		...
		<div class="site-container">
			<div class="about-me-slider">
				<div>
					...
					<img src="<?php echo get_template_directory_uri();?>/template/images/quotes.svg" alt="quotes svg">
					<h4>David Dixon</h4>
					<p>Reader</p>
				</div>
				<div>
		...
		<div class="site-container">
			<div class="social">
				...
				<div class="social-icons">
					<a href="#" target="_blank"><img src="<?php echo get_template_directory_uri();?>/template/images/social-twitter.png" alt="social icon"></a>
					<a href="#" target="_blank"><img src="<?php echo get_template_directory_uri();?>/template/images/social-pinterest.png" alt="social icon"></a>
					<a href="#" target="_blank"><img src="<?php echo get_template_directory_uri();?>/template/images/social-youtube.png" alt="social icon"></a>
					<a href="#" target="_blank"><img src="<?php echo get_template_directory_uri();?>/template/images/social-twitter.png" alt="social icon"></a>
				</div>
				<h5>Share it!</h5>
			</div>
			...
			<div class="footer-inner">
				<div class="footer-info">
					<div class="footer-info__left">
						<img src="<?php echo get_template_directory_uri();?>/template/images/footer-img.jpg" alt="about me image">
		...
		<div class="footer-bottom">
			<div class="site-container footer-bottom-inner">
				...
				<div class="footer-bottom__img">
					<img src="<?php echo get_template_directory_uri();?>/template/images/footer-mastercard.png" alt="footer image">
					<img src="<?php echo get_template_directory_uri();?>/template/images/footer-paypal.png" alt="footer image">
					<img src="<?php echo get_template_directory_uri();?>/template/images/footer-visa.png" alt="footer image">
					<img src="<?php echo get_template_directory_uri();?>/template/images/footer-fedex.png" alt="footer image">
					<img src="<?php echo get_template_directory_uri();?>/template/images/footer-dhl.png" alt="footer image">
				</div>
			</div>
		</div>
	</footer>
	...
	<!-- Scripts -->
	<script src="<?php echo get_template_directory_uri();?>/template/js/jquery.min.js"></script>
	<script src="<?php echo get_template_directory_uri();?>/template/js/slick.min.js"></script>
	<script src="<?php echo get_template_directory_uri();?>/template/js/main.js"></script>
